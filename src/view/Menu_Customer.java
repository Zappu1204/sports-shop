...
//    public Menu_Customer(String fullName, String userId, String phoneNumber, String Address) throws SQLException {
//        initComponents();
//        setTitle("Menu");
//        this.fullName = fullName;
//        this.userId = userId;
...
//    }
    ...
    private void initComponents() {
        ...
        txt_fullname3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        txt_numberphone3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        txt_gender3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        txt_dateofbirth3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel49)
                    .addComponent(txt_fullname3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel50)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_numberphone3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel51))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel52)
                    .addComponent(txt_address3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel53)
                    .addComponent(txt_gender3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(12, 12, 12)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel54)
                    .addComponent(txt_dateofbirth3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
        ...
        // Lấy thông tin sản phẩm từ bảng
            ...
            if (selectedRow != -1) { 
                try {
                    ...
                    int quantityInStock = productDAO.getQuantityInStock(productId); // Hàm lấy số lượng trong kho của sản phẩm               
                    ...
                    int quantityInCart = cartDAO.getProductQuantityInCart(cart.getCartId(), productId); // Hàm lấy số lượng sản phẩm đã có trong giỏ hàng
    ...
    private void jLb_orderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLb_orderMouseClicked
        ...
        cart_setting.setVisible(false);
            ...
            JOptionPane.showMessageDialog(this, "Please log in to access purchased Orders .", "Login Required", JOptionPane.ERROR_MESSAGE);
        }  
    ...
    private void btn_updateProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateProductActionPerformed
        ...
        // Lấy giá trị userId và productId
        String productId = table_showCart.getValueAt(selectedRow, 0).toString(); // Cột 0 là ProductId
        String userId = this.userId; // userId được truyền từ lớp hiển thị (đã lưu trước đó)    

        // Hiển thị hộp thoại nhập số lượng mới
        int updateQuantity;
        try {
            updateQuantity = (int) txt_setOfQuantity.getValue();
            if (updateQuantity < 0) {
        ...
        // Gọi hàm cập nhật trong CartDAO
        try {
            CartDAO cartDAO = new CartDAO();
    ...
    private void btn_orderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_orderActionPerformed
        try {
            // Giả sử bạn đã có đối tượng UserDAO
            ...
            JOptionPane.showMessageDialog(this,
                "An error occurred while fetching user data: " + e.getMessage(),
                "Database Error",
                JOptionPane.ERROR_MESSAGE
            );
        }
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        // Lấy giá trị của productId và userId (cartId chính là userId)
        String productId = table_showCart.getValueAt(selectedRow, 0).toString(); // Cột 0 là ProductId
        String userId = this.userId; // userId được truyền từ lớp hiển thị hoặc lưu trong biến toàn cục
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                if (isDeleted) {
                    ...
                    displayCartData(); // Làm mới lại dữ liệu giỏ hàng
                } else {
    ...
    private javax.swing.JButton btn_createUser2;
    private javax.swing.JButton btn_createUser4;
    private javax.swing.JButton btn_createUser5;
    private javax.swing.JButton btn_delete;
    private javax.swing.JButton btn_deleteUser;
    private javax.swing.JButton btn_deleteUser1;
    private javax.swing.JButton btn_deleteUser2;
    private javax.swing.JButton btn_deleteUser4;
    private javax.swing.JButton btn_deleteUser5;
    ...
    private javax.swing.JButton btn_updateUser2;
    private javax.swing.JButton btn_updateUser3;
    private javax.swing.JButton btn_updateUser4;
    private javax.swing.JButton btn_updateUser5;
    ...
    private javax.swing.JTextField txt_address4;
    private javax.swing.JTextField txt_address5;
    private javax.swing.JPasswordField txt_confpassword;
    private javax.swing.JTextField txt_dateofbirth;
    private javax.swing.JTextField txt_dateofbirth1;
    private javax.swing.JTextField txt_dateofbirth2;
    private javax.swing.JTextField txt_dateofbirth3;
    private javax.swing.JTextField txt_dateofbirth4;
    private javax.swing.JTextField txt_dateofbirth5;
    ...
    private javax.swing.JTextField txt_fullname5;
    ...
    private javax.swing.JTextField txt_gender4;
    private javax.swing.JTextField txt_gender5;
    private javax.swing.JTextField txt_numberphone;
    private javax.swing.JTextField txt_numberphone1;
    private javax.swing.JTextField txt_numberphone2;
    private javax.swing.JTextField txt_numberphone3;
    private javax.swing.JTextField txt_numberphone4;
    private javax.swing.JTextField txt_numberphone5;
    ...
    private javax.swing.JTextField txt_password4;
    private javax.swing.JTextField txt_password5;
