...
public class Manage_Users_Frame extends javax.swing.JFrame {
    ...
    private void txt_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_searchActionPerformed
        try {
            String search = txt_search.getText().trim(); // Lấy từ khóa tìm kiếm
            UserDAO userDAO = new UserDAO();            // Khởi tạo DAO
            String[][] users;

            if (search.isEmpty()) {
                // Nếu không có từ khóa, hiển thị toàn bộ người dùng
                users = userDAO.readAccountsTableData(); // Bạn cần phương thức này để lấy toàn bộ người dùng
            } else {
            ...
            DefaultTableModel model = new DefaultTableModel(users,
                new String[]{"UserId", "UserName", "Full Name", "Email", "Phone Number", "Address", "Gender", "Date Of Birth"}) {
                @Override
